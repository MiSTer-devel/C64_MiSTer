...
create_generated_clock -source [get_pins -compatibility_mode {*|mainpll|pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] \
...
set_multicycle_path -from [get_clocks {SDRAM_CLK}] \
                    -to [get_clocks {*|mainpll|pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] \
                                                  -setup 2
