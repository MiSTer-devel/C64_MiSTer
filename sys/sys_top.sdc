...
create_generated_clock -source [get_pins -compatibility_mode {emu|mainpll|pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] \
...
set_multicycle_path -from [get_clocks {SDRAM_CLK}] \
                    -to [get_clocks {emu|mainpll|pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] \
                                                  -setup 2
...
set_clock_groups -asynchronous \
   -group [get_clocks { emu|mainpll|pll_inst|altera_pll_i|general[*].gpll~PLL_OUTPUT_COUNTER|divclk}] \
